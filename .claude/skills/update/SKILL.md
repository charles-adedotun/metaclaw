...
**No upstream remote:** The fetch script auto-adds `upstream` pointing to `https://github.com/qwibitai/metaclaw.git`. If the user forked from a different URL, they should set the remote manually: `git remote add upstream <url>`.
