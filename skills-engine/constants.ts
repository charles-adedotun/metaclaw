export const METACLAW_DIR = '.metaclaw';
export const STATE_FILE = 'state.yaml';
export const BASE_DIR = '.metaclaw/base';
export const BACKUP_DIR = '.metaclaw/backup';
export const LOCK_FILE = '.metaclaw/lock';
export const CUSTOM_DIR = '.metaclaw/custom';
