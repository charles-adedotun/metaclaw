...
import { BACKUP_DIR, BASE_DIR, BASE_INCLUDES, METACLAW_DIR } from './constants.js';
...
export function initMetaclawDir(): void {
  const projectRoot = process.cwd();
  const metaclawDir = path.join(projectRoot, METACLAW_DIR);
