...
<html><head><title>MetaClaw - WhatsApp Auth</title>
...
<script>
  var startKey = 'metaclaw_qr_start';
...
<html><head><title>MetaClaw - Connected!</title>
<style>
...
<script>localStorage.removeItem('metaclaw_qr_start');</script>
</body></html>`;
